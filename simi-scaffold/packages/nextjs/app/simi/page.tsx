            ...
            <div className="mx-auto max-w-7xl px-4 pb-10 sm:px-6">
              <div className="card flex flex-col items-center p-10 text-center sm:p-14">
                <img
                  ...
                  alt="Mascota de SIMI"
                  className="mb-5 h-24 w-24 object-contain opacity-90 drop-shadow-lg"
                />
                <h2 className="text-2xl font-bold text-white">Wallet sin rol asignado</h2>
                <p className="mt-3 max-w-md text-pretty text-navy-300">
                  Esta wallet no tiene permisos dentro de SIMI. Cambia de wallet o solicita acceso
                  a un operador, verificador o titular de línea.
                </p>
              </div>
            </div>
          )}
